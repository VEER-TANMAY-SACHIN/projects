...
> **Verified Contact Email:** `info@onlinesbi.sbi`  
...
- **Primary Outreach Contact:** `info@onlinesbi.sbi` (`Unverified - guessed pattern`)
...
- **Resolved URL:** [https://onlinesbi.sbi](https://onlinesbi.sbi)
...
- **Primary Contact Email:** `info@onlinesbi.sbi` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@onlinesbi.sbi` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@onlinesbi.sbi` | **Status:** `Unverified - guessed pattern`
