...
> **Verified Contact Email:** `info@bemlindia.in`  
...
- **Primary Outreach Contact:** `info@bemlindia.in` (`Unverified - guessed pattern`)
...
- **Primary Contact Email:** `info@bemlindia.in` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@bemlindia.in` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@bemlindia.in` | **Status:** `Unverified - guessed pattern`
