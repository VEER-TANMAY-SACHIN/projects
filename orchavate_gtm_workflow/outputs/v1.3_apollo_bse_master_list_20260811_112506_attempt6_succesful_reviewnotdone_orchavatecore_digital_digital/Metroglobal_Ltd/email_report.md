...
> **Verified Contact Email:** `info@metrogloballimited.com`  
...
- **Primary Outreach Contact:** `info@metrogloballimited.com` (`Unverified - guessed pattern`)
...
- **Primary Contact Email:** `info@metrogloballimited.com` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@metrogloballimited.com` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@metrogloballimited.com` | **Status:** `Unverified - guessed pattern`
