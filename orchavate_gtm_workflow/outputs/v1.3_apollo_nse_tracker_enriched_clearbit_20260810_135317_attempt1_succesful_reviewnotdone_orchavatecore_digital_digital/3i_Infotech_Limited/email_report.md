...
> **Verified Contact Email:** `info@3i-infotech.com`  
...
- **Primary Outreach Contact:** `info@3i-infotech.com` (`Unverified - guessed pattern`)
...
- **Primary Contact Email:** `info@3i-infotech.com` (`Unverified - guessed pattern`)
- **Overall Discovery Status:** `Unverified - guessed pattern`

### Discovered Accessibility / Compliance Endpoints
- **General Contact Email (Guessed Pattern):** `info@3i-infotech.com` | **Status:** `Unverified - guessed pattern`
- **Investor Grievance Email (Guessed Pattern):** `contact@3i-infotech.com` | **Status:** `Unverified - guessed pattern`
